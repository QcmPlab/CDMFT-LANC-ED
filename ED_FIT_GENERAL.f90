...
contains
   ...
   subroutine chi2_fitgf_general(fg,bath_)
      ...
      integer                                               :: unit
      !
      if(size(fg,1)/=Nlat) stop "chi2_fitgf_general error: size[fg,1]!=Nlat"
      if(size(fg,2)/=Nlat) stop "chi2_fitgf_general error: size[fg,2]!=Nlat"
      if(size(fg,3)/=Nspin)stop "chi2_fitgf_general error: size[fg,3]!=Nspin"
      if(size(fg,4)/=Nspin)stop "chi2_fitgf_general error: size[fg,4]!=Nspin"
      if(size(fg,5)/=Norb) stop "chi2_fitgf_general error: size[fg,5]!=Norb"
      if(size(fg,6)/=Norb) stop "chi2_fitgf_general error: size[fg,6]!=Norb"
      !
   ...
   function chi2_delta_general_elemental(a) result(chi2)
      ...
      !
#ifdef _DEBUG
      if(ed_verbose>5)write(Logfile,"(A,"//str(size(a))//"ES10.2)")"DEBUG chi2_delta_general_elemental. a:",a
#endif
      !
      ...
      !
#ifdef _DEBUG
      if(ed_verbose>3)write(Logfile,"(A,ES10.2)")"DEBUG chi2_delta_general_elemental. chi2:",chi2
#endif
      !
   ...
   function chi2_weiss_general_elemental(a) result(chi2)
      ...
      !
#ifdef _DEBUG
      if(ed_verbose>5)write(Logfile,"(A,"//str(size(a))//"ES10.2)")"DEBUG chi2_weiss_general_elemental. a:",a
#endif
      !
      ...
      !
#ifdef _DEBUG
      if(ed_verbose>3)write(Logfile,"(A,ES10.2)")"DEBUG chi2_weiss_general_elemental. chi2:",chi2
#endif
      !
   ...
   function grad_chi2_delta_general_elemental(a) result(dchi2)
      ...
      !
#ifdef _DEBUG
      if(ed_verbose>5)write(Logfile,"(A,"//str(size(a))//"ES10.2)")"DEBUG grad_chi2_delta_general_elemental. a:",a
#endif
      !
      Delta  = delta_general(a)
      ...
      !
#ifdef _DEBUG
      if(ed_verbose>4)write(Logfile,"(A,"//str(size(a))//"ES10.2)")"DEBUG grad_chi2_delta_general_elemental. dChi2:",dchi2
#endif
      !
   ...
   function grad_chi2_weiss_general_elemental(a) result(dchi2)
      ...
      !
#ifdef _DEBUG
      if(ed_verbose>5)write(Logfile,"(A,"//str(size(a))//"ES10.2)")"DEBUG grad_chi2_weiss_general_elemental. a:",a
#endif
      !
      g0and  = g0and_general(a)
      ...
      !
#ifdef _DEBUG
      if(ed_verbose>4)write(Logfile,"(A,"//str(size(a))//"ES10.2)")"DEBUG grad_chi2_weiss_general_elemental. dChi2:",dchi2
#endif
      !
   ...
   function delta_general(a) result(Delta)
      ...
      real(8),dimension(Nbath,Nlat*Nspin*Norb)                      :: dummy_Vbath
      ...
      do ibath=1,Nbath
         ...
         !Get Vs
         dummy_vbath(ibath,:) = a(stride+1:stride+Nlat*Nspin*Norb)
   ...
   function grad_delta_general(a) result(dDelta)
      ...
      complex(8),dimension(Nlat*Nspin*Norb,Nlat*Nspin*Norb)                :: H_reconstructed,Htmp,Hbasis_lso,V_k
      ...
      do ibath=1,Nbath
         ...
         allocate(dummy_lambda(ibath)%element(Nlambdas(ibath)))
         !
         dummy_vbath(ibath,:) = a(counter+1:counter+Nlat*Nspin*Norb)
         counter = counter + Nlat*Nspin*Norb
         !
      ...
      do ibath=1,Nbath
         ...
         do l=1,Ldelta
            ...
            do k = 1,Nlat*Nspin*Norb
               ...
               dDelta(:,:,:,:,:,:,l,counter+k) = lso2nnn_reshape(Htmp,Nlat,Nspin,Norb)
            enddo
         enddo
         !
         !counter = counter + Nlat*Nspin*Norb
